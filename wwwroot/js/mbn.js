...
function Load(opt) {
    ...
    if (opt == "r7.1.2") {
        window.location = window.location.origin + "/content/parents/parents-721.html";
    }

    if (opt == "r7.1.3") {
        window.location = window.location.origin + "/content/parents/parents-731.html";
    }

    if (opt == "r7.1.4") {
        window.location = window.location.origin + "/content/parents/parents-741.html";
    }

    if (opt == "r7.1.5") {
        window.location = window.location.origin + "/content/parents/parents-751.html";
    }

    if (opt == "r7.1.6") {
        window.location = window.location.origin + "/content/parents/parents-761.html";
    }

    if (opt == "r7.1.7") {
        window.location = window.location.origin + "/content/parents/parents-771.html";
    }
