...
function Load(opt) {
    ...
    if(opt == "feeding-practices") {
        window.location = window.location.origin + "/tools/feeding-practices/quiz.html";
    }

    if(opt == "formula-preparation") {
        window.location = window.location.origin + "/tools/formula-preparation/quiz.html";
    }

    if(opt == "healthy-eating") {
        window.location = window.location.origin + "/tools/healthy-eating/quiz.html";
    }
    ...
    //
    if (opt == "r4.1.1") {
        window.location = window.location.origin + "/content/solids/solids-411.html";
    }

    if (opt == "r4.1.2") {
        window.location = window.location.origin + "/content/solids/solids-412.html";
    }

    if (opt == "r4.1.3") {
        window.location = window.location.origin + "/content/solids/solids-413.html";
    }

    if (opt == "r4.1.4") {
        window.location = window.location.origin + "/content/solids/solids-414.html";
    }

    if (opt == "r4.1.5") {
        window.location = window.location.origin + "/content/solids/solids-415.html";
    }

    if (opt == "r4.1.6") {
        window.location = window.location.origin + "/content/solids/solids-416.html";
    }

    if (opt == "r4.1.7") {
        window.location = window.location.origin + "/content/solids/solids-417.html";
    }

    if (opt == "r4.1.8") {
        window.location = window.location.origin + "/content/solids/solids-418.html";
    }

    if (opt == "r4.1.9") {
        window.location = window.location.origin + "/content/solids/solids-419.html";
    }

    if (opt == "r4.1.10") {
        window.location = window.location.origin + "/content/solids/solids-4110.html";
    }

    if (opt == "r4.1.11") {
        window.location = window.location.origin + "/content/solids/solids-4111.html";
    }

    if (opt == "r4.1.12") {
        window.location = window.location.origin + "/content/solids/solids-4112.html";
    }

    if (opt == "r4.1.13") {
        window.location = window.location.origin + "/content/solids/solids-4113.html";
    }

    if (opt == "r4.1.14") {
        window.location = window.location.origin + "/content/solids/solids-4114.html";
    }

    if (opt == "r4.1.15") {
        window.location = window.location.origin + "/content/solids/solids-4115.html";
    }

    if (opt == "r4.1.16") {
        window.location = window.location.origin + "/content/solids/solids-4116.html";
    }

    if (opt == "r4.1.17") {
        window.location = window.location.origin + "/content/solids/solids-4117.html";
    }
    ...
    //
    if (opt == "r6.1.1") {
        window.location = window.location.origin + "/content/recipe/recipe-611.html";
    }

    if (opt == "r6.2.1") {
        window.location = window.location.origin + "/content/recipe/recipe-621.html";
    }

    if (opt == "r6.3.1") {
        window.location = window.location.origin + "/content/recipe/recipe-631.html";
    }

    if (opt == "r6.4.1") {
        window.location = window.location.origin + "/content/recipe/recipe-641.html";
    }

    if (opt == "r6.5.1") {
        window.location = window.location.origin + "/content/recipe/recipe-651.html";
    }

    if (opt == "r6.6.1") {
        window.location = window.location.origin + "/content/recipe/recipe-661.html";
    }

    if (opt == "r6.7.1") {
        window.location = window.location.origin + "/content/recipe/recipe-671.html";
    }
    ...
    //
    if (opt == "r7.1.1") {
        window.location = window.location.origin + "/content/parents/parents-711.html";
    }

    if (opt == "r7.1.2") {
        window.location = window.location.origin + "/content/parents/parents-712.html";
    }

    if (opt == "r7.1.3") {
        window.location = window.location.origin + "/content/parents/parents-713.html";
    }

    if (opt == "r7.1.4") {
        window.location = window.location.origin + "/content/parents/parents-714.html";
    }

    if (opt == "r7.1.5") {
        window.location = window.location.origin + "/content/parents/parents-715.html";
    }

    if (opt == "r7.1.6") {
        window.location = window.location.origin + "/content/parents/parents-716.html";
    }

    if (opt == "r7.1.7") {
        window.location = window.location.origin + "/content/parents/parents-717.html";
    }
    ...
    if (opt == "r9.1.5a") {
        window.location = window.location.origin + "/content/play/play-915.html#9.1.5a";
    }

    if (opt == "r9.1.5p") {
        window.location = window.location.origin + "/content/play/play-915.html#9.1.5p";
    }

    if (opt == "r9.1.5ac") {
        window.location = window.location.origin + "/content/play/play-915.html#9.1.5ac";
    }

    if (opt == "r9.1.5ap") {
        window.location = window.location.origin + "/content/play/play-915.html#9.1.5ap";
    }

    if (opt == "r9.1.5bd") {
        window.location = window.location.origin + "/content/play/play-915.html#9.1.5bd";
    }

    if (opt == "r9.1.5bq") {
        window.location = window.location.origin + "/content/play/play-915.html#9.1.5bq";
    }

    if (opt == "r9.1.5ce") {
        window.location = window.location.origin + "/content/play/play-915.html#9.1.5ce";
    }

    if (opt == "r9.1.5ct") {
        window.location = window.location.origin + "/content/play/play-915.html#9.1.5ct";
    }

    if (opt == "r9.1.5dh") {
        window.location = window.location.origin + "/content/play/play-915.html#9.1.5dh";
    }

    if (opt == "r9.1.5dv") {
        window.location = window.location.origin + "/content/play/play-915.html#9.1.5dv";
    }

    if (opt == "r9.1.5ek") {
        window.location = window.location.origin + "/content/play/play-915.html#9.1.5ek";
    }

    if (opt == "r9.1.5ey") {
        window.location = window.location.origin + "/content/play/play-915.html#9.1.5ey";
    }

    if (opt == "r9.1.5fn") {
        window.location = window.location.origin + "/content/play/play-915.html#9.1.5fn";
    }
    ...
    if (opt == "r10.1.2a") {
        window.location = window.location.origin + "/content/py/py-1012.html#10.1.2a";
    }

    if (opt == "r10.1.2s") {
        window.location = window.location.origin + "/content/py/py-1012.html#10.1.2s";
    }

    if (opt == "r10.1.2u") {
        window.location = window.location.origin + "/content/py/py-1012.html#10.1.2u";
    }

    if (opt == "r10.1.2w") {
        window.location = window.location.origin + "/content/py/py-1012.html#10.1.2w";
    }

    if (opt == "r10.1.2ae") {
        window.location = window.location.origin + "/content/py/py-1012.html#10.1.2ae";
    }

    if (opt == "r10.1.2ah") {
        window.location = window.location.origin + "/content/py/py-1012.html#10.1.2ah";
    }
