(function() {
    ...
    app.directive("post", function() {
        return {
            ...
            controller: [
                ...
                "$scope",
                "$sce",
                function($rootScope, $http, $scope, $sce) {
                    $scope.comment = {};
                    $scope.comments = [];
                    ...
                    $http
                        ...
                        .success(function(respondData) {
                            $scope.postUser.avatar = atob(respondData.profile_photo);
                            ...
                            $scope.postUser.userEmail = respondData.user_email;
                        });
                    ...
                    $scope.goProfilePage=function(){
                        if($scope.post.userId===$scope.userId)
                    ...
                    $scope.addLikes = function(post) {
                        $scope.$parent.postPagination.busy = true;
                        ...
                        $http
                            ...
                            .success(function(respondData) {
                                ...
                                $scope.$parent.postPagination.busy = false;
                    ...
                    $scope.deletePost = function(post) {
                        $http.get(
                            "https://assc-klong-gh.azurewebsites.net/api/delete_post?postId=" + post.id
                        ).then(function(data) {
                            if (data.status === 200) {
                                $rootScope.$broadcast('allPosts', post);
                            }
                        });
                    };
                    ...
                    $scope.reportPost = function(post) {
                        $http.post(
                            "http://assc-klong-gh.azurewebsites.net/api/send_mail", {
                                to: "zhangjing881105@gmail.com",
                                to_name: "MBN admin",
                                from: $scope.userEmail,
                                from_name: $scope.userName,
                                subject: "Report spam",
                                html: 'Post id: ' + post.id + '<br>Post user name: ' + $scope.postUser.userName + '<br>Post user email: ' + $scope.postUser.userEmail + '<br>Post content: ' + post.content
                            }
                        ).success(function(data) {
                            Materialize.toast('Report successful!', 4000);
                        });
                    };
                }
            ],
    ...
    app.directive("postComments", function() {
        return {
            restrict: "E",
            templateUrl: "../forum/post-comments.html",
            controller: [
                "$http",
                "$scope",
                function($http, $scope) {
                    ...
                    $http
                        ...
                        .success(function(data) {
                            ...
                            $http
                                ...
                                .success(function(data) {
                                    $scope.user = data;
                                    $scope.user.profile_photo=atob(data.profile_photo);
                                });
                        });
    ...
    app.directive("secondLevelComments", function() {
        return {
            restrict: "E",
            templateUrl: "../forum/second-level-comments.html",
            controller: [
                "$http",
                "$scope",
                function($http, $scope) {
